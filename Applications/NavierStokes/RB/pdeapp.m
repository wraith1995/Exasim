...
pde.dt = 0.01*ones(20000,1);   % time step sizes
pde.visdt = pde.dt(1);         % visualization timestep size
pde.saveSolFreq = 5000;          % solution is saved every 100 time steps
pde.soltime = 5000:5000:20000; % steps at which solution are collected
...
[mesh.p,mesh.t] = squaremesh(20,20,0,1);
L = 5.0;
mesh.p(1,:) = L*mesh.p(1,:);
