...
pde.dt = 0.015*ones(40000,1);   % time step sizes
pde.visdt = pde.dt(1);         % visualization timestep size
pde.saveSolFreq = 100;          % solution is saved every 100 time steps
pde.soltime = 100:100:40000; % steps at which solution are collected
...
[mesh.p,mesh.t, mesh.dgnodes] = sphere_cube2(R0,R1,20,15,pde.porder);
